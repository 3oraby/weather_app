...
class IntroPageData {
  static List<IntroPageModel> introPagesDataList = [
    IntroPageModel(
    ...
    IntroPageModel(
      ...
      pageDescription:
          "you can search for the current and future weather in any city now",
      pageImage: "assets/animations/intro gif2.json",
    ),
    IntroPageModel(
      pageColor: const Color.fromARGB(255, 44, 43, 43),
      pageDescription:
          "let's make search now for the weather in your city or in another city 🔍",
